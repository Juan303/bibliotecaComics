...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
                ...
                <div class="col-md-12">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form action="" class="form-inline">
                           <div class="input-group">
                                <input name="search_string" class="form-control py-2 border-right-0 border" type="search" placeholder="buscar coleccion..." id="search_string">
                        ...
                        <div class="dropdown">
                            <a class="btn btn-info px-5 ml-2" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true" v-pre>
        ...
        <script type="text/javascript" src="{{ asset('js/typeahead.bundle.js') }}" type="text/javascript"></script>
